...
#python ../datasetFillCsv.py --nomove --cfg dataset_bp_au_24.cfg --csv BP4D-caucasian.csv ../../dataset ../../../databases/BP4D/images ../../../databases/BP4D/aucoding
#python ../cropFaces.py --single --cfg dataset_bp_au_24.cfg --eye-correction ../../dataset
#7z a -mmt dataset_BP4D-caucasian.7z ../../dataset
